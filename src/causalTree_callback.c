...
{
    Rprintf("Entered causalTree_callback -> init_ctcallback\n");
    SEXP stemp;
...
{
    Rprintf("Entered causalTree_callback -> init_ctcallback1\n");
    int i, j, k;
    SEXP value;
    double *dptr;
...
{ 
    Rprintf("Entered causalTree_callback -> init_ctcallback2\n");
    int i, j, k;
    SEXP goodness;
    double *dptr;
